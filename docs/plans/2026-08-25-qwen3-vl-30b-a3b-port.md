...
- [x] **Step 1: Add a real-shape config fixture and failing decode assertions**
...
- [x] **Step 2: Add failing construction and registry tests**
...
- [x] **Step 3: Run the focused tests and observe the expected failures**
...
- [x] **Step 1: Decode the optional MoE schema with dense defaults**
...
- [x] **Step 2: Install the target-shaped sparse block**
...
- [x] **Step 3: Add an independent small-tensor arithmetic test**
...
- [x] **Step 4: Install the checkpoint-specific vision activation profile**
...
- [x] **Step 1: Add registry and documentation entries**
...
- [x] **Step 2: Download the pinned artifact outside Git**
...
- [x] **Step 3: Strict-load the real checkpoint**
...
- [x] **Step 4: Compare greedy text and image generation with Python**
...
revision, prompt/media SHA-256, output token IDs, decoded output, available
phase metrics, and command lines in the JSON receipts. Record Python peak
memory explicitly; the temporary Swift runner does not expose that metric.
...
- [x] **Step 2: Run implementation hygiene and diff audits**
...
- [x] **Step 3: Commit, push, and open the requested PR**
...
focused/full test commands, strict-load result, text/image parity receipts,
