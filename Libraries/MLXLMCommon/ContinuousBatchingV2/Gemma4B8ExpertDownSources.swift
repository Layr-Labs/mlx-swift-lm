// Copyright © 2026 Eigen Labs. Apple notices retained in source literals.
// Retained scheduling from challenge27c821c4. Affine load helpers below use
// current-core3fa8f25e widening before the bias sum; native qualification gates remain.
enum Gemma4B8ExpertDownSources {
    static let source = #"""
